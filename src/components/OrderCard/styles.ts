...
export type StatusTypeProps = "Preparing" | "Done" | "Delivered";
...
export const StatusLabel = styled.Text<StatusProps>`
    ...
    ${({status, theme}) => css`
        font-family: ${theme.FONTS.TEXT};
        color: ${status === 'Preparing' ? theme.COLORS.SUCCESS_900: theme.COLORS.TITLE};
    `}
`;
